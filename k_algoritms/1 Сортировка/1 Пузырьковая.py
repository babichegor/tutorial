...
какого либо массива значений сортировка идет путем сравнивания двух соседних чисел
если число справа больше того что слева делаем своп
если нет то седующая пара чисел и так до конца
после первого прохода самое большое число будет справа
поэтому длинну массива можно уменьшить на 1"""

"""1 - создаем массив
   2 - узнать длинну массива минус 1 так как отсчет идет от индекса 0 можно начать с 1 тогда минус не нужен
   3 - создаем цикл от 0 до длинны массива
